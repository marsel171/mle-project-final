...
от частоты использования этого банковского продукта; 
    - Прогнозирование отсутствующих продуктов;
...
данных, такие как (возраст, пол, доход, активность, стаж и место жительства) с применением алгоритма k-средних;
   ...
   IV. Объединение базовых алгоритмов: 

    - Получение прогнозов по всем алгоритмам, объединение и сортировка рейтингов в порядке убывания и рекомендация клиенту первых N продуктов.
